...
angular
  ...
  .controller('MainController', ['$scope', function($scope) {
    ...
    defaultDate: date, // Getting current date 
    minDate: "1900-01-01",
    maxDate: "3000-12-31",


    dayNamesLength: 3, // 1 for "M", 2 for "Mo", 3 for "Mon"; 9 will show full day names. Default is 3.
  ...
  $scope.events = [
    {name: 'toplanti', date: "2018-08-18"},
    {name: 'toplanti2', date: "2018-08-20"},
    {name: 'toplanti3', date: "2018-08-20"},
    {name: 'toplanti4', date: "2018-08-20"},
    {name: 'toplanti5', date: "2018-08-26"}
  ];
$scope.todaysEvents = [];

   
    $scope.add = function(appointment) {    //adding new appointment
